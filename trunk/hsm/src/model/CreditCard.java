...
/**
 * This class represents the subtype CreditCard of the supertype Payment.
 * 
 * @author D20018
 * 
 */
...
public class CreditCard extends Payment {
	...
	/**
	 * Customized Constructor to create a new creditcard object
	 * 
	 ...
	 * @param expieringDate
	 */
	public CreditCard(String cardHoldersName, String creditCardNumber,
			String cvvCode, String expieringDate) {
		super();
